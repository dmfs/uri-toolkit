...
public class FormEncodedTest
{
    ...
    public void testToString() throws Exception
    {
        ...
        assertEquals("0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ",
                new FormEncoded("0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ").toString());
        assertEquals(".-_~", new FormEncoded(".-_~").toString());
        assertEquals("%25%2F%22%26%3D%C3%9C%C3%96%C3%84a%C2%B9%C2%B2%C2%B3%C2%BC%C2%BD%C2%AC%40" +
                        ...
                        "%80%9C%E2%80%9D%C2%B5%E2%80%A6%C2%B7%C3%A2%C3%B4%C3%AA%C3%A0%C3%A8%C3%B2%C3%B9%C3%A2+",
                new FormEncoded("%/\"&=ÜÖÄa¹²³¼½¬@æſðđŋħłł€¶ŧ←↓→øþ«¢„“”µ…·âôêàèòùâ ").toString());
        assertEquals("%2B+%0D%0A", new FormEncoded("+ \n").toString());
        assertEquals("%2B+%0D%0A", new FormEncoded("+ \r\n").toString());
    }
